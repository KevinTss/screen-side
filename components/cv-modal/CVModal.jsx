...
import { Overlay, ModalContainer, ModalBar, CloseButton, DownloadButton, Sheet } from "./style"
    ...
    <>
      ...
      <Overlay onClick={onClose}>
        <ModalContainer onClick={(e) => e.stopPropagation()}>
          <ModalBar>
            <DownloadButton onClick={() => window.print()}>Download PDF</DownloadButton>
            <CloseButton onClick={onClose} aria-label="Close CV">&#x2715;</CloseButton>
          </ModalBar>
          <Sheet>
            <CVContent />
          </Sheet>
